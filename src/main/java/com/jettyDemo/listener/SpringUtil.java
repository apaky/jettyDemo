...
public class SpringUtil {
    ...
    /**
     * spring上下文提供两种注入方式：1启动servlet的时候从web.xml注入
     * 2.若没有启动web服务或servlet注入失败,直接手动注入
     */
    public static ApplicationContext getDefaultWebApplicationContext() {
        if (context == null) {
            context = new FileSystemXmlApplicationContext(new String[] {
                    ...
                    "file:src/main/webapp/WEB-INF/jettyDemo-servlet.xml", });
        }
        return context;
    }
    ...
    public static Object getBean(String beanName) {
        ...
        try {
            ...
            ApplicationContext ctx = getDefaultWebApplicationContext();
